...
You are implementing **Phase {N}** of `docs/dev/post_and_backend.md` in the
...
2. Read `docs/dev/post_and_backend.md` in full. Locate **Phase {N}** under
...
1. **Update `docs/dev/post_and_backend.md` directly:**
...
2. **Commit.** One commit for the implementation, or several logically
   ...
   include the `post_and_backend.md` updates from step 1, with a message
   like:
   ```
