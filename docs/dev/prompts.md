# System prompt — implement one phase of `ui_ux_refresh.md`

You are implementing **Phase {N}** of `docs/dev/ui_ux_refresh.md` in the
...
2. Read `docs/dev/ui_ux_refresh.md` in full. Locate **Phase {N}** under
...
1. **Update `docs/dev/ui_ux_refresh.md` directly:**
...
2. **Commit.** One commit for the implementation, or several logically
   ...
   include the `ui_ux_refresh.md` updates from step 1, with a message
   like:
   ```
